...
# source://rack-session//lib/rack/session.rb#7
module Rack
  class << self
    # source://rack/3.1.3/lib/rack/version.rb#18
    def release; end
  end
end

# source://rack-session//lib/rack/session.rb#8
...
#
# source://rack-session//lib/rack/session/pool.rb#26
class Rack::Session::Pool < ::Rack::Session::Abstract::PersistedSecure
  # @return [Pool] a new instance of Pool
  #
  # source://rack-session//lib/rack/session/pool.rb#30
  def initialize(app, options = T.unsafe(nil)); end

  # source://rack-session//lib/rack/session/pool.rb#61
  def delete_session(req, session_id, options); end

  # source://rack-session//lib/rack/session/pool.rb#44
  def find_session(req, sid); end

  # source://rack-session//lib/rack/session/pool.rb#37
  def generate_sid(*args, use_mutex: T.unsafe(nil)); end

  # Returns the value of attribute mutex.
  #
  # source://rack-session//lib/rack/session/pool.rb#27
  def mutex; end
  ...
  # source://rack-session//lib/rack/session/pool.rb#54
  def write_session(req, session_id, new_session, options); end

  private

  # source://rack-session//lib/rack/session/pool.rb#71
  def get_session_with_fallback(sid); end
end

# source://rack-session//lib/rack/session/pool.rb#28
