...
class Rack::Builder
  ...
  # source://rack/3.1.3/lib/rack/builder.rb#116
  def initialize(default_app = T.unsafe(nil), **options, &block); end

  # source://rack/3.1.3/lib/rack/builder.rb#276
  def call(env); end

  # source://rack/3.1.3/lib/rack/builder.rb#259
  def freeze_app; end

  # source://rack/3.1.3/lib/rack/builder.rb#252
  def map(path, &block); end

  # source://rack/3.1.3/lib/rack/builder.rb#132
  def options; end

  # source://rack/3.1.3/lib/rack/builder.rb#193
  def run(app = T.unsafe(nil), &block); end

  # source://rack/3.1.3/lib/rack/builder.rb#264
  def to_app; end

  # source://rack/3.1.3/lib/rack/builder.rb#159
  def use(middleware, *args, **_arg2, &block); end

  # source://rack/3.1.3/lib/rack/builder.rb#209
  def warmup(prc = T.unsafe(nil), &block); end

  private

  # source://rack/3.1.3/lib/rack/builder.rb#284
  def generate_map(default_app, mapping); end

  class << self
    # source://rack/3.1.3/lib/rack/builder.rb#136
    def app(default_app = T.unsafe(nil), &block); end

    # source://rack/3.1.3/lib/rack/builder.rb#87
    def load_file(path, **options); end

    # source://rack/3.1.3/lib/rack/builder.rb#102
    def new_from_string(builder_script, path = T.unsafe(nil), **options); end

    # source://rack/3.1.3/lib/rack/builder.rb#65
    def parse_file(path, **options); end
  end
end

class Rack::CommonLogger
  # source://rack/3.1.3/lib/rack/common_logger.rb#29
  def initialize(app, logger = T.unsafe(nil)); end

  # source://sinatra//lib/sinatra/base.rb#264
  def call(env); end

  # source://rack/3.1.3/lib/rack/common_logger.rb#41
  def call_without_check(env); end

  private

  # source://rack/3.1.3/lib/rack/common_logger.rb#83
  def extract_content_length(headers); end

  # source://rack/3.1.3/lib/rack/common_logger.rb#52
...
class Sinatra::Request < ::Rack::Request
  ...
  # source://rack/3.1.3/lib/rack/request.rb#410
  def secure?; end
