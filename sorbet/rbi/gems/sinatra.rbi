...
class Sinatra::ExtendedRack < Anonymous_Struct_5
...
class Sinatra::Base
  ...
  def initialize(app = nil, **_kwargs); end
  ...
  def self.delete(path, opts = nil, &block); end
  ...
  def self.handler_name?; end
  def self.head(path, opts = nil, &block); end
  def self.helpers(*extensions, &block); end
  ...
  def self.link(path, opts = nil, &block); end
  def self.lock; end
  ...
  def self.on_start(&on_start_callback); end
  def self.on_start_callback; end
  def self.on_stop(&on_stop_callback); end
  def self.on_stop_callback; end
  def self.options(path, opts = nil, &block); end
  def self.patch(path, opts = nil, &block); end
  def self.port; end
  def self.port=(val); end
  def self.port?; end
  def self.post(path, opts = nil, &block); end
  ...
  def self.public_folder?; end
  def self.put(path, opts = nil, &block); end
  def self.quiet; end
  ...
  def self.traps?; end
  def self.unlink(path, opts = nil, &block); end
  ...
  def self.views?; end
  def self.warn_for_deprecation(message); end
